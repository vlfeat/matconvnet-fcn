...
net.addLayer('deconv', ...
  dagnn.ConvTranspose('upsample', 32, 'crop', 6, 'numGroups', 21, 'hasBias', false), ...
  'x38', 'prediction', 'deconvf') ;

f = net.getParamIndex('deconvf') ;
net.params(f).value = single(bilinear_u(64, 21, 21)) ;
net.params(f).learningRate = 0 ;
net.params(f).weightDecay = 1 ;
  
% Make the output of the bilinear interpolator precious
