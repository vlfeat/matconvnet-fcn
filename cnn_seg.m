...
opts.train.learningRate = [0.001*ones(1,30) 0.0001*ones(1,30)] ;
...
net.layers{end+1} = struct('type', 'conv', 'name', 'class6', ...
                           'weights', {{0.01 * randn(1, 1, 256, 2048, 'single'), zeros(1,1,2048,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'learningRate', 10*[1 2], ...
                           'weightDecay', [1 0]) ;
...
net.layers{end+1} = struct('type', 'conv', 'name', 'class7', ...
                           'weights', {{0.01 * randn(1, 1, 2048, 2048, 'single'), zeros(1,1,2048,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'learningRate', 10*[1 2], ...
                           'weightDecay', [1 0]) ;
...
net.layers{end+1} = struct('type', 'conv', 'name', 'class8', ...
                           'weights', {{0.01 * randn(1, 1, 2048, 21, 'single'), zeros(1,1,21,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'learningRate', 10*[1 2], ...
                           'weightDecay', [1 0]) ;
